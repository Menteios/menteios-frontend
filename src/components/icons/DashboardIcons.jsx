/**
 * Native inline SVG icon set for the dashboard (sidebar nav + summary cards).
 * All icons share the same viewBox/stroke API so they're interchangeable and
 * inherit color via `currentColor` — no icon library dependency.
 */
...
export function SessionsIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function ReportsIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CircleIcon({ className = 'h-5 w-5' }) {
  return (
...
export function WhatsAppIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      ...
      <path d="M20.52 3.449C18.24 1.245 15.24 0 12.045 0 5.463 0 .105 5.36.103 11.943c0 2.105.549 4.16 1.595 5.978L0 24l6.223-1.632a11.94 11.94 0 0 0 5.822 1.482h.005c6.581 0 11.939-5.361 11.941-11.944 0-3.191-1.238-6.19-3.471-8.457zM12.05 21.785h-.004a9.878 9.878 0 0 1-5.031-1.378l-.361-.214-3.741.981.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.211c.002-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.436 9.836-9.885 9.836z" />
    </svg>
  )
}
